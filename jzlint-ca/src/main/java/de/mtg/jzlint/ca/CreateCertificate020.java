...
/**
 * Certificates for lints: e_etsi_natural_person_key_usage_correct_values
 */
public class CreateCertificate020 {
    ...
    public static void main(String[] args) throws Exception {
...

        {
            ...
            String details = "certificate is issued to a natural person and has keu usage extension with allowed value";
...

        {
            ...
            String name = "qcNaturallWithDisallowedKU";
            String expectedResult = "Error";
            String details = "certificate is issued to a natural person and has keu usage extension with dataEncipherment";
