...
/**
 * Certificates for lints: e_etsi_natural_person_key_usage_mandatory
 */
public class CreateCertificate019 {
    ...
    public static void main(String[] args) throws Exception {
...

        {
            ...
            String details = "certificate is issued to a natural person and has keu usage extension";
...

        {
            ...
            X509Certificate testCertificate = createTestCertificate(subjectDN, "0.4.0.194112.1.4", null);//QEVCPwPolicyOID
