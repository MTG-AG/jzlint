...
class MlDsaCaPublicKeyAidEncodingTest {
    ...
    void passTest() throws Exception {
        ...
        pqccaExtension.assertLintResult(LintResult.of(Status.PASS), new MlDsaCaPublicKeyAidEncoding(), certificate);
    }

    @Test
    void naTest() throws Exception {
        X509Certificate certificate = PQCCAExtension.createECCertificate();
        pqccaExtension.assertLintResult(LintResult.of(Status.NA), new MlDsaCaPublicKeyAidEncoding(), certificate);
    }
    ...
    void errorTest() throws Exception {
        ...
        pqccaExtension.assertLintResult(LintResult.of(Status.ERROR), new MlDsaCaPublicKeyAidEncoding(), certificate);
    }
